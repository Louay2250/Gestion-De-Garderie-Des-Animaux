...
public class PersonnelController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // Associer les colonnes aux propriétés de la classe Personnel
        ...
        if (selectedPersonnel != null) {
            ...
            result.ifPresent(pair -> {
                if (pair.getKey()) {
                    ...
                    selectedPersonnel.setCIN(updatedPersonnel.getCin());
                    selectedPersonnel.setNom(updatedPersonnel.getNom());
                    selectedPersonnel.setAdresse(updatedPersonnel.getAdresse());
                    selectedPersonnel.setTelephone(updatedPersonnel.getTelephone());
                    selectedPersonnel.setPoste(updatedPersonnel.getPoste());
                    selectedPersonnel.setSalaire(updatedPersonnel.getSalaire());
    ...
    @FXML
    private void ClickAnmx(ActionEvent event) {
    }
